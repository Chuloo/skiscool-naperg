...
var Component = function () {
  ...
  _createClass(Component, null, [{
    ...
    value: function init(classDef, els, options) {
      ...
      } else if (!!els && (els.jquery || els.cash || els instanceof NodeList || els instanceof Object)) {
        var instancesArr = [];
  ...
  var Dropdown = function (_Component2) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleDropdownKeydown(e) {
        ...
        if (letter && nonLetters.indexOf(e.which) === -1) {
          ...
          var string = this.filterQuery.join(''),
              newOptionEl = $(this.dropdownEl).find('li').filter(function (i,el) {
      ...
      value: function _makeDropdownFocusable() {
        ...
        var dd=this.dropdownEl.children;  
  ...
  var Tabs = function (_Component6) {
    ...
    _createClass(Tabs, [{
      ...
      value: function _setupNormalTabs() {
        // Hide Tabs Content
        this.$tabLinks.not(this.$activeTabLink).each(function (i,link) {
          if (!!link.hash) {
            var $currContent = $(M.escapeHash(link.hash));
...
;(function ($, anim) {
  ...
  var Sidenav = function (_Component8) {
    ...
    _createClass(Sidenav, [{
      ...
      key: "init",
      value: function init(els, options) {
      console.log(_get(Sidenav.__proto__, "init", this),els, options)
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function _exit() {
        ...
        if (ScrollSpy._visibleElements[0]) {
          ...
          ScrollSpy._visibleElements = ScrollSpy._visibleElements.filter(function (i,el) {
...
;(function ($, anim) {
  ...
  var Slider = function (_Component11) {
    ...
    function Slider(el, options) {
      ...
      _this40.$slides.find('.caption').each(function (i,el) {
        _this40._animateCaptionIn(el, 0);
      });

      // Move img src into background-image
      _this40.$slides.find('img').each(function (i,el) {
      ...
      _this40.$active.find('img').each(function (i,el) {
        anim({
    ...
    _createClass(Slider, [{
      ...
      value: function _setupEventHandlers() {
        ...
        if (this.options.indicators) {
          this.$indicators.each(function (i,el) {
      ...
      value: function set(index) {
        ...
        if (this.activeIndex != index) {
          ...
          anim({
            ...
            easing: 'easeOutQuad',
            complete: function () {
              _this44.$slides.not('.active').each(function (i,el) {
                anim({
                  targets: el,
                  opacity: 0,
                  translateX: 0,
  ...
  var Chips = function (_Component12) {
    ...
    _createClass(Chips, [{
      ...
      value: function deleteChip(chipIndex) {
        ...
        this.$chips = this.$chips.filter(function (i,el) {
          return $(el).index() >= 0;
        });
  ...
  var FloatingActionButton = function (_Component14) {
    ...
    _createClass(FloatingActionButton, [{
      ...
      value: function _animateInFAB() {
        ...
        var time = 0;
        this.$floatingBtnsReverse.each(function (i,el) {
          anim({
            targets: el,
            opacity: 1,
            scale: [0.4, 1],
  ...
  var FormSelect = function (_Component20) {
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupEventHandlers() {
        ...
        $(this.dropdownOptions).find('li:not(.optgroup)').each(function (i,el) {
      ...
      value: function _setupDropdown() {
        ...
        if (this.$selectOptions.length) {
          this.$selectOptions.each(function (i,el) {
            if ($(el).is('option')) {
              ...
              selectOptions.each(function (i,el) {
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onOpenEnd = function (i,el) {
